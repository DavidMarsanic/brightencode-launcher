...
- `brightencode.json` — `{version, dependencies[], requirements[]}`; parsed directly by brightencode-web's `lib/releases.ts`/`lib/utilities.ts`. This is a real, live-consumed schema, not aspirational.
